...
|---|---|---|---|---|---|---|---|---|
| 完整 2016–2026 | 2,305 | **51.4%** | +0.895R | 1.014R | **0.883** | −0.033R | **53.1%** | −$38,434 |
| 開發期 2016–2024 | 1,724 | 50.2% | +0.895R | 1.034R | 0.865 | −0.066R | 53.6% | −$57,264 |
| 樣本外 2024+ | 581 | **54.9%** | +0.894R | 0.945R | **0.946** | +0.065R | **51.4%** | +$18,830 |
...
在模擬器裡填 "1:1"，兩平線會被放在 50%，於是 51.4% 的勝率看起來會賺 ——
**而完整歷史實際上是虧 $38,434 的**。

### 用哪一段的勝率，就決定你得到什麼答案

完整歷史 51.4% < 兩平 53.1% → 虧。樣本外 54.9% > 兩平 51.4% → 賺。
...
- R 的 lag-1 自相關 **+0.031**、勝負的 **+0.025**，都接近 0
- 最長連虧 **7 筆**，隨機重排的平均 **7.3 筆**
- 實際最大回撤 −19.23R，重排中位數 −15.02R，實際值在第 **18** 百分位 ——
  偏差但在正常範圍，不是離群值
